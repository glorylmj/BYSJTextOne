    ...
    <table align="center" border="1" width="800">
        ...
        <tr>
            <td colspan="7" style="font-size:12px">
                <a href="employees.jsp?pageIndex=1">首页</a>
                <%
                    if(pages.getPageIndex()>1) {
                %>
                <a href="employees.jsp?pageIndex=<%=(pageIndex-1)%>">上一页</a>
                <%
                    }
                %>
                <%
                ...
                %>
                <a href="employees.jsp?pageIndex=<%=i%>">[<%=i %>]</a>
                <%
                        }
                    }
                %>
                ...
                %>
                <a href="employees.jsp?pageIndex=<%=(pageIndex+1)%>">下一页</a>
                <%
                    }
                %>
                <a href="employees.jsp?pageIndex=<%=totalPage%>">尾页</a>
            </td>
        </tr>
    </table>
